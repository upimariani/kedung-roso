        ...
        <nav id="sidebar" class="sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item <?php if ($this->uri->segment(1) == 'Pemilik' && $this->uri->segment(2) == 'cLaporan_TransaksiDev') {
                                                echo 'active';
                                            }  ?>">
                        <a class="sidebar-link" href="<?= base_url('Pemilik/cLaporan_TransaksiDev') ?>">
                            <i class="align-middle" data-feather="shopping-cart"></i> <span class="align-middle">Laporan Transaksi Delivery</span>
                        </a>
                    </li>
