		...
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					<li class="sidebar-item <?php if ($this->uri->segment(1) == 'AdminCS' && $this->uri->segment(2) == 'cDashboard') {
												echo 'active';
											}  ?>">
						<a class="sidebar-link" href="<?= base_url('AdminCS/cDashboard') ?>">
					...
					<li class="sidebar-item <?php if ($this->uri->segment(1) == 'AdminCS' && $this->uri->segment(2) == 'cChatting') {
												echo 'active';
											}  ?>">
						<a class="sidebar-link" href="<?= base_url('AdminCS/cChatting') ?>">
