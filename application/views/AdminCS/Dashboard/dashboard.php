						...
						?>
								...
								<div class="media-body">
									...
									<strong><?= $value->nama_plggn ?></strong> <?= $value->komentar ?> <strong><br />
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<a href="<?= base_url('AdminCS/cDashboard/hapus_ulasan/' . $value->id_ulasan) ?>" class="btn btn-danger btn-block">Hapus Ulasan</a>
											</div>
										</div>
							...
							<div class="modal fade" id="defaultModalPrimary<?= $value->id_ulasan ?>" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<form action="<?= base_url('AdminCS/cDashboard/balas_ulasan/' . $value->id_ulasan) ?>" method="POST">
